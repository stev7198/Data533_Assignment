...
class TestToplists(unittest.TestCase):
    ...
    def setUp(self): 
        print('Set Up')
        self.topteams_test = ['2023', 5]
        self.topassists_test = ['2024', 6]
        self.topgoals_test = ['2021', 3]
    ...
    def test_TopTeams(self, mock_input):
        ...
        mock_input.side_effect = self.topteams_test
    ...
    def test_TopAssists(self, mock_input):
        ...
        # Mock the user input for year, number of players
        mock_input.side_effect = self.topassists_test
    ...
    def test_TopGoals(self, mock_input):
        ...
        # Mock the user input for year, number of players
        mock_input.side_effect = self.topgoals_test
